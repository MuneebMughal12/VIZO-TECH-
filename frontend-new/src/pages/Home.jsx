        ...
        <div className="glass-card rounded-[2.5rem] p-8 md:p-16 flex flex-col md:flex-row gap-16 overflow-hidden relative">
            ...
            {contactSuccess ? (
              ...
              <form onSubmit={handleContactSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <input
                    className={`border rounded-xl px-6 py-4 focus:outline-none w-full text-sm ${theme === 'dark' ? 'bg-white/5 border-white/10 text-white focus:border-[#00f0ff]' : 'bg-[#f8f9fa] border-black/10 text-black focus:border-[#0052FF]'
                      }`}
                ...
                <textarea
                  className={`border rounded-xl px-6 py-4 focus:outline-none w-full text-sm h-32 resize-none ${theme === 'dark' ? 'bg-white/5 border-white/10 text-white focus:border-[#00f0ff]' : 'bg-[#f8f9fa] border-black/10 text-black focus:border-[#0052FF]'
                    }`}
          ...
          <div className="flex-1 flex flex-col justify-center items-center md:items-start text-center md:text-left z-10">
            <div className="mb-8 p-8 bg-white/5 dark:bg-black/20 rounded-3xl border border-white/10">
              <span className={`material-symbols-outlined text-6xl mb-4 ${theme === 'dark' ? 'text-[#00f0ff]' : 'text-[#0052FF]'
                }`}>chat_bubble</span>
